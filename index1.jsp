...
<body id="page-top">
	...
	<nav
		...
		<div class="container">
			<a class="navbar-brand" href="#page-top">Student Performance Analyzer</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="registration1.jsp">Signup</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="login1.jsp">Login</a></li>
					<!--  <li class="nav-item mx-0 mx-lg-1"><a
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Student Performance Analysis System is a software or tool that is used to evaluate and analyze the academic performance of students. 
					It typically includes the collection, storage, and analysis of student data such as grades, test scores, and other relevant information. </p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">The system can generate reports, visualizations, and other forms of analysis to 
					provide insights into student performance and identify areas for improvement. </p>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						Indore <br /> Madhya Pradesh, 452010
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
